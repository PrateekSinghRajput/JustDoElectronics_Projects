...
#define PIN_SET_BTN   12
#define PIN_INC_BTN   11
#define PIN_NEXT_BTN  10
#define PIN_RED_LED   9
#define PIN_YELL_LED  8
...
void setup() {
  ...
  // === SET YOUR CLOCK TIME HERE (UNCOMMENT ONCE) ===
  // rtc.adjust(DateTime(2026, 2, 3, 7, 16, 0));  // YYYY, MM, DD, 24HR, MM, SS
